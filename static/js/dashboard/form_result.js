$(document).ready(function(){
  // Switch Between Round trip To One Way 
    function applyActiveStyles() {
      if ($('#oneway').hasClass('active')) {
          ...
          $('.clone_count').hide();
          $('.append_clone').hide();
      } else if ($('#round_trip').hasClass('active')) {
          ...
          $('.clone_count').hide();
          $('.append_clone').hide();
      } else if ($('#multiple').hasClass('active')) {
          $('.return_date_col').hide();
          $('.flexible_col').hide();
  ...
  // Apply styles based on the initial active button
  applyActiveStyles();
...
$(document).on('click', '.swap_btn_result', function () {
  ...
  $('#addMore').on('click', function(){
    if(cloneCount < maxClones){
      var clonedDiv = $('#multi_clone_result').clone();
      clonedDiv.attr('id', 'multi_clone_result_' + cloneCount);
  ...
  function reNumberFlights() {
    $('.append_clone .clone_count').each(function (index) {
        ...
        $(this).attr('id', 'multi_clone_result_' + index); // Update the clone ID
